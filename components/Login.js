    ...
    return (
      <form action="" method="post">
        <div className="row"  ref = {elem => this.elem = elem}>
            ...
            <span className="hidden is-error">Incorrect credentials. Please try again with correct credentials. </span>
            <input type="submit" className="btn btn-default" onClick={this.login} value="Login" />
            <p><Link href="/signup">New User? Signup here</Link></p>
        </div>
      </form>
    );
  }
